...
public class Vote implements Command, Serializable {
    ...
    private static EmbedBuilder getParsedPoll(Poll poll, Guild guild){
        ...
        return new EmbedBuilder()
                ...
                .setFooter("Enter: '" + STATICS.PREFIX + "vote v <number>' or react to vote", null)
                .setColor(Color.CYAN);
    ...
    private void votePoll(String[] args, GuildMessageReceivedEvent event){
    ...
    public static void reactVote(String reaction, MessageReactionAddEvent event) throws IOException, ClassNotFoundException {
        ...
        if(poll.votes.containsKey(event.getUser().getId())){
            embedSender.sendEmbed("Sorry, but you can only vote at once for a poll " + event.getMember().getAsMention(),event.getChannel(), Color.red);
            new Timer().schedule(new TimerTask() {
                @Override
                public void run() {
        ...
        switch (emoji) {
            case "\uD83C\uDF4F":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `1`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF4E":
                poll.votes.put(event.getUser().getId(), 2);
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `2`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF50":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `3`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF4A":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `4`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF4B":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `5`", privch, new Color(0x3AD70E));
                break;
            case "\ud83c\udf4c":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `6`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF49":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `7`", privch, new Color(0x3AD70E));
                break;
            case "\ud83c\udf7a":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `8`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF53":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `9`", privch, new Color(0x3AD70E));
                break;
            case "\uD83C\uDF48":
                ...
                polls.replace(event.getGuild(), poll);
                embedSender.sendEmbed("You have succesfully voted for option `10`", privch, new Color(0x3AD70E));
    ...
    private void voteStats(GuildMessageReceivedEvent event){
        if(!polls.containsKey(event.getGuild())){
            message("There is currently no poll running on this guild", Color.red);
            return;
        }
    ...
    public String help() {
        ...
        return
                "USAGE: \n" +
                        "`  " + STATICS.PREFIX + "vote create <Title>|<Option1>|<Option2>|...  `  -  create a vote\n" +
                        "`  " + STATICS.PREFIX + "vote vote <index of Option>  `  -  vote for a possibility\n" +
                        "`  " + STATICS.PREFIX + "vote stats  `  -  get stats of a current vote\n" +
                        "`  " + STATICS.PREFIX + "vote close  `  -  close a current vote"
                ;
    }
